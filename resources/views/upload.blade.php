...
<body class="flex flex-col gap-7 justify-center items-center h-screen font-[poppins]" id="main_body">
    <div class="w-fit flex flex-col gap-7 items-center">
        ...
        <div class="border-2 border-gray-200 border-dashed w-[530px] rounded-3xl transition-[width] duration-500 self-start" id="border_upload">
            <div class="form-child">
                <div class="form-image-upload-container">
                    <img src='' class="form-image-preview" style="display: none;">
                    <section class="flex flex-col form-image-information items-center content-center justify-center ">
                    ...
                    <input type="file" name="thumbnail" {{ isset($post->thumbnail) ? '' : 'required' }}
        ...
        <div class="flex flex-col items-center gap-2">
            <div class="flex gap-3 items-center border-2  px-3 py-2.5 rounded-2xl border-gray-200">
                ...
                <div class="bg-blue-300 text-white rounded-full p-2 cursor-pointer hover:bg-blue-200 !bg-gray-500 !cursor-default" id="send_image">
